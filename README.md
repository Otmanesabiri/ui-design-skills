...
See what the framework produces when all skills are activated. This is not a mockup; it's production-ready code generated by an agent using our design tokens and UX laws.

*   **[Showcase: SaaS Marketing Page](skills/design-interface/examples/showcase-saas/index.html)** — *Dark, premium, high-conversion.*
*   **[Showcase: Real-time Dashboard](skills/design-interface/examples/showcase-saas/dashboard.html)** — *Dense, readable, interactive.*

*Explore the full prompt used for this generation in [example-showcase-saas.md](skills/design-interface/examples/example-showcase-saas.md).*
